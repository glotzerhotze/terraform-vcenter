...
////  datastore     = "${data.vsphere_datastore.esx-02-local-storage-example-1.name}"
////  type          = "thin"
////}
//
...
//  // TODO: setup hostname
//  name                       = "<hostname>"
//  resource_pool_id           = "${data.vsphere_resource_pool.esx-02.id}"
//  datastore_id               = "${data.vsphere_datastore.esx-02-local-storage-example-1.id}"
//
//  num_cpus                   = 1
//  memory                     = 512
//
//  guest_id                   = "${data.vsphere_virtual_machine.esx-02-centos-latest.guest_id}"
//  wait_for_guest_net_timeout = -1
//  nested_hv_enabled          = true
//
//  network_interface {
//    network_id   = "${data.vsphere_network.internal.id}"
//    adapter_type = "${data.vsphere_virtual_machine.esx-02-centos-latest.network_interface_types[0]}"
//  }
//
//  disk {
//    // TODO: change naming - use disk0 to be backwards-compatible
//    label       = "<hostname>-disk0"
//    size        = "${data.vsphere_virtual_machine.esx-02-centos-latest.disks.0.size}"
//    unit_number = 0
//  }
//
//  clone {
//    template_uuid = "${data.vsphere_virtual_machine.esx-02-centos-latest.id}"
//
//    customize {
//
//      linux_options {
